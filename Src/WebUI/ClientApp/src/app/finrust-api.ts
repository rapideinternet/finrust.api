...
export interface ICalculationClient {
    getCalculation(query: GetCalculationQuery): Observable<number>;
}
...
export class CalculationClient implements ICalculationClient {
    ...
    protected processGetCalculation(response: HttpResponseBase): Observable<number> {
...
export class GetCalculationQuery implements IGetCalculationQuery {
    type?: Type;
    dateTime?: Date;
    net?: boolean;

    constructor(data?: IGetCalculationQuery) {
        if (data) {
    ...
    static fromJS(data: any): GetCalculationQuery {
        data = typeof data === 'object' ? data : {};
        let result = new GetCalculationQuery();
        result.init(data);
        return result;
    }
...
export interface IGetCalculationQuery {
    type?: Type;
    dateTime?: Date;
    net?: boolean;
}
